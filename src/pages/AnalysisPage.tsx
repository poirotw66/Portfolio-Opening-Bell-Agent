...
export function AnalysisPage() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 w-full min-w-0 flex-1">
      {/* Left Column: Input — narrower sidebar to give more width to report/dashboard */}
      <div className="lg:col-span-3 space-y-6 shrink-0">
